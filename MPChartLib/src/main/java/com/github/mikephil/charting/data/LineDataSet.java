...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
    ...
    public DataSet<Entry> copy() {
        ...
        copied.mDrawLowCircle = mDrawLowCircle;
        copied.mLowNumbers = mLowNumbers;
        return copied;
    }
    ...
    public void setLowDrawCircles(boolean enabled) {
        this.mDrawLowCircle = enabled;
    }

    @Override
    public boolean isLowDrawCirclesEnabled() {
        return mDrawLowCircle;
    }

    public void setLowNumbers(float lowNumbers) {
        this.mLowNumbers = lowNumbers;
    }

    @Override
    public float getLowNumbers() {
        return mLowNumbers;
    }
